<header>
    <div class="headerpanel">
        ...
        <div class="logopanel">
            <h2><a href="/buyer/dashboard">CarZa</a></h2>
        </div><!-- logopanel -->
                    ...
                    <li>
                        <div class="btn-group">
                            <button type="button" class="btn btn-logged" data-toggle="dropdown">
                                <img src="../images/photos/loggeduser.png.jpg" tppabs="http://themetrace.com/demo/quirk/images/photos/loggeduser.png" alt="" />
                                Elen Adarna
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu pull-right">
                                <li><a href="profile.html" tppabs="http://themetrace.com/demo/quirk/templates/profile.html"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
                                <li><a href="#"><i class="glyphicon glyphicon-cog"></i> Account Settings</a></li>
                                <li><a href="#"><i class="glyphicon glyphicon-question-sign"></i> Help</a></li>
                                <li><a href="signin.html" tppabs="http://themetrace.com/demo/quirk/templates/signin.html"><i class="glyphicon glyphicon-log-out"></i> Log Out</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
